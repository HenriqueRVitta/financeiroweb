  ...
  text-shadow: 4px 4px 4px #aaa;
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-2 text-gray-800">Deseja realmente excluir Contas a Receber ?</h1>
          </div>
	...
	<div>
    	...
    	<form name='deletecontasreceber' method='POST' action='../../controller/contasrecebercontroller.php'>
    		<input type='text' name='idcontasreceberdelete' id='idcontasreceberdelete' value='<?php echo $dados->id; ?>' hidden='hidden'>
